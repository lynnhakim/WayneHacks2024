...
export default function Variables(){
    ...
    <div>
      <Navbar />
        ...
        <h1 className="font-bold text-lg text-white">A guard appears in front of you! He won't let you pass unless you follow his instructions. He asks you the following:</h1>
